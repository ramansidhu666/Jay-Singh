    ...
    public partial class Property_New1 : System.Web.UI.MasterPage
    {
        ...
        private void SetValuesFaceBookShare()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                fbProprtyUrl.Content = string.Format("http://sellwithjay.com/PropertyDetails.aspx?MLSID={0}&PropertyType={1}", dt.Rows[0]["MLS"].ToString(), dt.Rows[0]["pType"].ToString());
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<a class='toggleMenu' href='#'></a> <div class='navbar-brand navbar-brand-centered menu_logo'><img title='' alt='' src='images/menu_logo.png' /></div>");
                //StrMenu.Append("<div class='collapse navbar-collapse' id='navbar-brand-centered'>");
                StrMenu.Append("<ul class='nav navbar-nav'>");
                ...
                StrMenu.Append("</ul><ul class='nav navbar-nav navbar-right'>");
                StrMenu.Append("<li>");
                StrMenu.Append("<a href='Virtualtour.aspx' title='Virtual Tour'>Virtual Tour</a>");
                StrMenu.Append("</li>");
